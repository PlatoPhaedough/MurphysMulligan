...
////// Emissive:
                ...
                float3 emissive = tex2D(_EmissiveTex,TRANSFORM_TEX(node_62, _EmissiveTex)).rgb;
///////// Gloss:
                float gloss = 0.5;
