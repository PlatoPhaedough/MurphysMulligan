...
/////// Diffuse:
                ...
                finalColor += diffuseLight * saturate((saturate((1.0-(1.0-_HatchingColor.rgb)*(1.0-node_2)))*_node_243.rgb));
/// Final Color:
