        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                void displacement (inout VertexInput v){
                    float4 node_854 = _Time + _TimeEditor;
                    float2 node_6 = (v.texcoord0.rg*5.0);
                    float2 node_161 = (node_6+node_854.g*float2(1,0));
                    float node_15 = 1.0;
...
////// Specular:
                NdotL = max(0.0, NdotL);
                float2 node_855 = i.uv0;
                float3 node_162 = lerp(float3(0.9411765,0.5459015,0.2422145),(tex2D(_Diffuse,TRANSFORM_TEX(node_855.rg, _Diffuse)).rgb*tex2D(_AORGBHeightA,TRANSFORM_TEX(node_6, _AORGBHeightA)).rgb),node_156);
...
/// Final Color:
        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                void displacement (inout VertexInput v){
                    float4 node_856 = _Time + _TimeEditor;
                    float2 node_6 = (v.texcoord0.rg*5.0);
                    float2 node_161 = (node_6+node_856.g*float2(1,0));
                    float node_15 = 1.0;
                    float4 node_152 = tex2Dlod(_DisplacementR,float4(TRANSFORM_TEX(node_161, _DisplacementR),0.0,node_15));
                    float4 node_12 = tex2Dlod(_AORGBHeightA,float4(TRANSFORM_TEX(node_6, _AORGBHeightA),0.0,node_15));
                    v.vertex.xyz +=  (v.normal*((1.0 - max(node_152.r,node_12.a))*((-1.0)*_Depth)));
...
////// Specular:
                NdotL = max(0.0, NdotL);
                float2 node_857 = i.uv0;
                float3 node_162 = lerp(float3(0.9411765,0.5459015,0.2422145),(tex2D(_Diffuse,TRANSFORM_TEX(node_857.rg, _Diffuse)).rgb*tex2D(_AORGBHeightA,TRANSFORM_TEX(node_6, _AORGBHeightA)).rgb),node_156);
                float node_165 = (node_156*node_162.r);
                float3 specularColor = float3(node_165,node_165,node_165);
...
/// Final Color:
        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                void displacement (inout VertexInput v){
                    float4 node_858 = _Time + _TimeEditor;
                    float2 node_6 = (v.texcoord0.rg*5.0);
                    float2 node_161 = (node_6+node_858.g*float2(1,0));
                    float node_15 = 1.0;
                    float4 node_152 = tex2Dlod(_DisplacementR,float4(TRANSFORM_TEX(node_161, _DisplacementR),0.0,node_15));
                    float4 node_12 = tex2Dlod(_AORGBHeightA,float4(TRANSFORM_TEX(node_6, _AORGBHeightA),0.0,node_15));
                    v.vertex.xyz +=  (v.normal*((1.0 - max(node_152.r,node_12.a))*((-1.0)*_Depth)));
        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                void displacement (inout VertexInput v){
                    float4 node_859 = _Time + _TimeEditor;
                    float2 node_6 = (v.texcoord0.rg*5.0);
                    float2 node_161 = (node_6+node_859.g*float2(1,0));
                    float node_15 = 1.0;
                    float4 node_152 = tex2Dlod(_DisplacementR,float4(TRANSFORM_TEX(node_161, _DisplacementR),0.0,node_15));
                    float4 node_12 = tex2Dlod(_AORGBHeightA,float4(TRANSFORM_TEX(node_6, _AORGBHeightA),0.0,node_15));
                    v.vertex.xyz +=  (v.normal*((1.0 - max(node_152.r,node_12.a))*((-1.0)*_Depth)));
