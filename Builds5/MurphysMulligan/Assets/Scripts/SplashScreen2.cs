...
public class SplashScreen2 : MonoBehaviour {
    ...
    void Start()
    {
        ...
        if (logoPositioning == LogoPositioning.Centered)
        {
            ...
            //splashLogoPos.x = (Screen.width / 4);
            //splashLogoPos.y = (Screen.height / 8);

            //splashLogoPos.width = (Screen.width / 4) * 2;
            //splashLogoPos.height = (Screen.height /4) * 3;

            splashLogoPos.x = (default_width / 2) - 225;
            splashLogoPos.y = (default_height / 2) - 250;

            splashLogoPos.width = 450;
            splashLogoPos.height = 400;
